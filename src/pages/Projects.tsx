    ...
    <div className="relative min-h-screen w-full flex flex-col items-center pt-40 pb-20 px-4 md:px-12 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1400px] flex flex-col gap-6">
        ...
        <div className="glass-pill bg-[#0a0a0a] text-white px-8 py-5 flex items-center justify-center relative overflow-hidden shadow-2xl">
          ...
          <h1 className="text-2xl md:text-3xl font-black tracking-[0.3em] relative z-10 text-center uppercase">
            Projects
          </h1>
        </div>

        {/* Advanced Slider Section */}
        <div className="glass-pill bg-[#0a0a0a] text-white p-6 md:p-12 relative flex flex-col items-center justify-center min-h-[700px] shadow-2xl">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/5 pointer-events-none rounded-[2.5rem]" />

          <div className="w-full flex items-center justify-between mb-8 z-20 px-4 md:px-8">
            <button
              onClick={prev}
              className="w-14 h-14 bg-white/10 rounded-full flex items-center justify-center text-white hover:bg-white transition-colors hover:text-black shrink-0 backdrop-blur-md shadow-xl"
            >
              <ChevronLeft size={28} />
            </button>
            <div className="text-white/50 tracking-[0.4em] text-sm font-bold uppercase hidden md:block">
            ...
            <AnimatePresence mode="popLayout">
              {projects.map((project, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-full h-full bg-[#111] rounded-3xl overflow-hidden border border-white/10 shadow-2xl flex flex-col group">
                      ...
                      {/* Content Section */}
                      <div className="h-1/2 p-6 md:p-8 flex flex-col justify-between relative bg-[#111]">
                        <div>
                          <div className="inline-block px-4 py-1.5 rounded-full border border-white/20 bg-white/5 text-white/70 text-[10px] md:text-xs font-bold tracking-widest uppercase mb-4">
                            {project.highlight}
                          </div>
                          <h2 className="text-xl md:text-3xl font-black leading-tight mb-4 tracking-wide text-white">
                            {project.title}
                          </h2>
                        ...
                        {isActive && (
                          <div className="mt-4 flex justify-end">
                            <div className="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center hover:scale-110 transition-transform cursor-pointer shadow-lg">
